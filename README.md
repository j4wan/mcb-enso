...
## Data access
Note, you will need to populate `_data` with associated data files available from NCAR GDEX. Small data files used in analysis but not in repository are provided in `_data`. See `/_data/data_README.txt` for more information.
